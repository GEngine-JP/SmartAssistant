...
// 必要なコンポーネントの列記
	...
	public class UnityChanControlScriptWithRgidBody : MonoBehaviour
	{
		...
		private static readonly int JumpHeight = Animator.StringToHash("JumpHeight");
		private static readonly int GravityControl = Animator.StringToHash("GravityControl");
